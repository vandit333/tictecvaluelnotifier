                  ...
                  children: [
                    InkWell(
                      child: Container(
                        ...
                        margin: EdgeInsets.all(5),
                        alignment: Alignment.center,
                        child: ValueListenableBuilder<String>(valueListenable: s1, builder: (context, value, child) => Text(s1.value),),
                      ),
                      onTap: (){
                        if(s1.value=="")
                        {
                    ...
                    InkWell(
                      child: Container(
                        ...
                        alignment: Alignment.center,
                        child: ValueListenableBuilder<String>(valueListenable: s2, builder: (context, value, child) => Text(s2.value),),
                      ),
                      onTap: (){
                        if(s2.value=="")
                        {
                    ...
                    InkWell(
                      child: Container(
                        ...
                        margin: EdgeInsets.all(5),
                        alignment: Alignment.center,
                        child: ValueListenableBuilder<String>(valueListenable: s3, builder: (context, value, child) => Text(s3.value),),
                      ),
                      onTap: (){
                        if(s3.value=="")
                        {
                  ...
                  children: [
                    InkWell(
                      child: Container(
                        ...
                        alignment: Alignment.center,
                        child: ValueListenableBuilder<String>(valueListenable: s4, builder: (context, value, child) => Text(s4.value),),
                      ),
                      onTap: (){
                        if(s4.value=="")
                        {
                    ...
                    InkWell(
                      child: Container(
                        ...
                        alignment: Alignment.center,
                        child: ValueListenableBuilder<String>(valueListenable: s5, builder: (context, value, child) => Text(s5.value),),
                      ),
                      onTap: (){
                        if(s5.value=="")
                        {
                    ...
                    InkWell(
                      child: Container(
                        ...
                        alignment: Alignment.center,
                        child: ValueListenableBuilder<String>(valueListenable: s6, builder: (context, value, child) => Text(s6.value),),
                      ),
                      onTap: (){
                        if(s6.value=="")
                        {
                  ...
                  children: [
                    InkWell(
                      child: Container(
                        ...
                        margin: EdgeInsets.all(5),
                        alignment: Alignment.center,
                        child: ValueListenableBuilder<String>(valueListenable: s7, builder: (context, value, child) => Text(s7.value),),
                      ),
                      onTap: (){
                        if(s7.value=="")
                        {
                    ...
                    InkWell(
                      child: Container(
                        ...
                        margin: EdgeInsets.fromLTRB(0, 5, 0, 5),
                        alignment: Alignment.center,
                        child: ValueListenableBuilder<String>(valueListenable: s8, builder: (context, value, child) => Text(s8.value),),
                      ),
                      onTap: (){
                        if(s8.value=="")
                          {
                    ...
                    InkWell(
                      child: Container(
                        ...
                        margin: EdgeInsets.all(5),
                        alignment: Alignment.center,
                        child: ValueListenableBuilder<String>(valueListenable: s9, builder: (context, value, child) => Text(s9.value),),
                      ),
                      onTap: (){
                        if(s9.value=="")
                          {
